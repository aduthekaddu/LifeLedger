...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:bg-[#0a0e27] flex items-center justify-center px-4 relative overflow-hidden">
      {/* Theme Toggle */}
      <ThemeToggle />
      ...
      >
        <div className="text-center mb-8">
          ...
          >
            Sign in to your LifeLedger account
          </motion.p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition disabled:opacity-50 flex items-center justify-center space-x-2 shimmer"
            >
              {loading ? (
                <>
                  <motion.div
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/register" className="text-blue-600 hover:text-purple-600 font-semibold transition">
                Register
              </Link>
            </p>
          </div>
